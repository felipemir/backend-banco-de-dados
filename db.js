...
const pool = mysql.createPool({
  host: process.env.DB_HOST || 'trolley.proxy.rlwy.net', // Fallback para localhost
  user: process.env.DB_USER || 'root',      // Fallback para seu usuário local
  password: process.env.DB_PASSWORD || 'SswolwDlebjbAuznySNEUAeXHoIkETne',  // Fallback para sua senha local
  database: process.env.DB_NAME || 'railway', // Fallback para seu DB local
